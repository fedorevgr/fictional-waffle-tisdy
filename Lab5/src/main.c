...
size_t changeValue(size_t oldValue);
...
int main(void) {
  ...
  do {
    ...
    switch (mode) {
    case ARRAY:
      simulateArrayQueue(maxPoolTime, maxServeTime, verbose, showAddresses,
                         &result);
      break;
    case LIST:
      simulateListQueue(maxPoolTime, maxServeTime, verbose, showAddresses,
                        &result);
      break;
    case EXPERIMENT:
      serviceExperiment();
    ...
    case CHANGE_VERBOSE:
      verbose = !verbose;
      break;
    case CHANGE_ADDRESS_DISPLAY:
      showAddresses = !showAddresses;
      break;
    case CHANGE_POOL_TIMER:
      maxPoolTime = changeValue(maxPoolTime);
      break;
    case CHANGE_SERVE_TIMER:
      maxServeTime = changeValue(maxServeTime);
      break;
    case EXIT:
      printf("Exiting...\n");
      break;
